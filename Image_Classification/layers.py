...
'''
Acquire image features

x: 2*3*32*32 
w: 32*3*7*7  
pad = 3，stride = 1
width*length：(32-7+2*3)/1 + 1 = 32
size of output：2*32*32*32
'''
...
'''
The convolution of back propagation： convolution kernel 3*7*7
input dout:2*32*32*32
output dx:2*3*32*32
'''
